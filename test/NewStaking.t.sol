...
contract EdgelessDepositTest is PRBTest, StdCheats, StdUtils {
    ...
    //     assertAlmostEq(LIDO.balanceOf(address(edgelessDeposit)), amount, 10, "Edgeless should have `amount` of
    // steth");
    ...
    //     assertAlmostEq(LIDO.balanceOf(address(edgelessDeposit)), amount, 2, "Edgeless should have `amount` of
    // steth");
    //     assertEq(wrappedEth.balanceOf(depositor), amount, "Depositor should have `amount` of wrapped eth");
    ...
    //     );
    //     assertAlmostEq(USDC.balanceOf(address(edgelessDeposit)), 0, 2, "Edgeless should have 0 usdc after
    // withdrawing");
    ...
    //         wrappedUSD.balanceOf(depositor), 0, 2, "Depositor should have 0 wrapped stablecoin after withdrawing"
    //     );
    //     assertAlmostEq(USDT.balanceOf(address(edgelessDeposit)), 0, 2, "Edgeless should have 0 usdt after
    // withdrawing");
    //     assertAlmostEq(DAI.balanceOf(address(edgelessDeposit)), 0, 2, "Edgeless should have 0 DAI after
    // withdrawing");
    // }
    ...
    //     assertEq(LIDO.balanceOf(address(edgelessDeposit)), 0, "Edgeless should have `amount` of eth after
    // withdrawing");
    // }
    ...
    //     randomL1BridgeAddress = address(uint160(bound(uint256(uint160(randomL1BridgeAddress)), 1,
    // type(uint160).max)));
    //     vm.startPrank(depositor);
    //     vm.expectRevert();
